...
exports.html = n;
},{"preact":"node_modules/preact/dist/preact.module.js","htm":"node_modules/htm/dist/htm.module.js"}],"src/types.ts":[function(require,module,exports) {
"use strict";
...
},{"preact":"node_modules/preact/dist/preact.module.js"}],"src/context.ts":[function(require,module,exports) {
"use strict";
...
exports.Provider = function (_a) {
  var children = _a.children,
      _b = _a.store,
      reducer = _b.reducer,
      initialState = _b.initialState; // this is where the state lives
  // state is not shared between providers

  var _c = hooks_1.useState(initialState),
      state = _c[0],
      setState = _c[1]; // Wrap dipsatch to easily invert the control for async creators.
...
exports.Consumer = exports.ctx.Consumer; // HOC for connecting components to context
...
},{"htm/preact":"node_modules/htm/preact/index.module.js","preact":"node_modules/preact/dist/preact.module.js","preact/hooks":"node_modules/preact/hooks/dist/hooks.module.js"}],"src/hooks.ts":[function(require,module,exports) {
"use strict";
...
},{"preact/hooks":"node_modules/preact/hooks/dist/hooks.module.js","./context":"src/context.ts"}],"src/combine-reducers.ts":[function(require,module,exports) {
"use strict";
...
exports.combineReducers = function (reducers) {
  ...
  var reducer = function reducer(state, action) {
    return reducerKeys.reduce(function (acc, key) {
      ...
      return __assign(__assign({}, acc), (_a = {}, _a[key] = state ? reducers[key](state[key], action) : reducers[key](undefined, {}), _a));
    }, {
      __reducer__metadata__: function __reducer__metadata__() {
        return {
          __composite__reducer__: true
        };
      }
    });
  };
...
exports.ActionsObject = types_1.ActionsObject;
exports.WrappedActionsObject = types_1.WrappedActionsObject;
exports.selectorFn = types_1.selectorFn;
exports.reducerFn = types_1.reducerFn;
exports.dispatchFn = types_1.dispatchFn;
exports.creatorFn = types_1.creatorFn;
exports.asyncCreatorFn = types_1.asyncCreatorFn;
exports.ReducerAction = types_1.ReducerAction;
exports.ProviderContext = types_1.ProviderContext;
exports.Store = types_1.Store;
...
},{"./types":"src/types.ts","./hooks":"src/hooks.ts","./context":"src/context.ts","./combine-reducers":"src/combine-reducers.ts"}],"demo.ts":[function(require,module,exports) {
"use strict";
...
var src_1 = require("./src"); // Reducer Function
...
var store = src_1.createStore(reducer); // Hooks component

var Counter = function Counter() {
  var state = src_1.useSelector(function (state) {
    return state;
  });
...
var CounterConnect = src_1.connect(function (state) {
  return {
    state: state
  };
}, {
...
},{"htm/preact":"node_modules/htm/preact/index.module.js","./src":"src/index.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
